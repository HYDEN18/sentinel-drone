...
if("TRUE" STREQUAL "TRUE")
  set(edrone_client_SOURCE_PREFIX /home/hyden/catkin_ws/src/sentinel_drone/task_1/edrone_client)
  set(edrone_client_DEVEL_PREFIX /home/hyden/catkin_ws/devel/.private/edrone_client)
  ...
  set(edrone_client_INSTALL_PREFIX /home/hyden/catkin_ws/install)
...
if(NOT "/home/hyden/catkin_ws/devel/.private/edrone_client/include " STREQUAL " ")
  set(edrone_client_INCLUDE_DIRS "")
  set(_include_dirs "/home/hyden/catkin_ws/devel/.private/edrone_client/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'edrone_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hyden/catkin_ws/src/sentinel_drone/task_1/edrone_client/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT edrone_client_NUM_DUMMY_TARGETS)
      set(edrone_client_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::edrone_client::wrapped-linker-option${edrone_client_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR edrone_client_NUM_DUMMY_TARGETS "${edrone_client_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::edrone_client::wrapped-linker-option${edrone_client_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND edrone_client_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/hyden/catkin_ws/devel/.private/edrone_client/lib;/home/hyden/catkin_ws/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(edrone_client_EXPORTED_TARGETS ${${edrone_client_dep}_EXPORTED_TARGETS})
endforeach()
