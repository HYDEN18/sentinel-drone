...
(cl:in-package sentinel_drone_driver-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <CommandBool-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandBool-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sentinel_drone_driver-srv:<CommandBool-request> is deprecated: use sentinel_drone_driver-srv:CommandBool-request instead.")))

(cl:ensure-generic-function 'value-val :lambda-list '(m))
(cl:defmethod value-val ((m <CommandBool-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentinel_drone_driver-srv:value-val is deprecated.  Use sentinel_drone_driver-srv:value instead.")
  (value m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CommandBool-request>)))
  ...
  "sentinel_drone_driver/CommandBoolRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommandBool-request)))
  "Returns string type for a service object of type 'CommandBool-request"
  "sentinel_drone_driver/CommandBoolRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <CommandBool-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandBool-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sentinel_drone_driver-srv:<CommandBool-response> is deprecated: use sentinel_drone_driver-srv:CommandBool-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <CommandBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentinel_drone_driver-srv:success-val is deprecated.  Use sentinel_drone_driver-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <CommandBool-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sentinel_drone_driver-srv:result-val is deprecated.  Use sentinel_drone_driver-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CommandBool-response>)))
  ...
  "sentinel_drone_driver/CommandBoolResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommandBool-response)))
  "Returns string type for a service object of type 'CommandBool-response"
  "sentinel_drone_driver/CommandBoolResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommandBool)))
  ...
  "sentinel_drone_driver/CommandBool")